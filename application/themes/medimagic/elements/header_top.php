...
<head>
    ...
    <!-- Author -->
    <meta name="author" content="Badar Rashdi | Webdesign, Webshops & E-marketing">
    ...
    $title = $metaTitle ? $metaTitle : ($pageType == 'home' ?  $site :  $page->getCollectionName());
    ...
    <link rel="stylesheet" href="https://use.typekit.net/zka2xoc.css" />
    <script>
