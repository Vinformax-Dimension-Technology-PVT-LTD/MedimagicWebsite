		...
		switch ($this->element->getPropertyValue('min_max_type')) {
			case 'words':
				...
				if (count($words) < $this->element->getPropertyValue('min_value') || (count($words) > $this->element->getPropertyValue('max_value') && $this->element->getPropertyValue('max_value') > 0)) {
					if ($this->element->getPropertyValue('max_value') > 0) $this->addError('ERROR_WORDS_BETWEEN', array($this->element->getPropertyValue('min_value'), $this->element->getPropertyValue('max_value')));
			...
			case 'chars':
				if (!$str->min($value, $this->element->getPropertyValue('min_value')) || (!$str->max($value, $this->element->getPropertyValue('max_value')) && $this->element->getPropertyValue('max_value') > 0)) {
					if ($this->element->getPropertyValue('max_value') > 0) $this->addError('ERROR_CHARS_BETWEEN', array($this->element->getPropertyValue('min_value'), $this->element->getPropertyValue('max_value')));
			...
			case 'value':
				if ($value < $this->element->getPropertyValue('min_value') || ($value > $this->element->getPropertyValue('max_value') && $this->element->getPropertyValue('max_value') > 0)) {
					if ($this->element->getPropertyValue('max_value') > 0) $this->addError('ERROR_VALUE_BETWEEN', array($this->element->getPropertyValue('min_value'), $this->element->getPropertyValue('max_value')));	
			...
			case 'options':
				...
				if (count($value) < $this->element->getPropertyValue('min_value') || (count($value) > $this->element->getPropertyValue('max_value') && $this->element->getPropertyValue('max_value') > 0)) {
					...
					else $this->addError('ERROR_OPTION_BETWEEN', array($this->element->getPropertyValue('min_value'), $this->element->getPropertyValue('max_value')));
				}
			break;				
			case 'files':
				$value = array_filter($value);
				if (count($value) < $this->element->getPropertyValue('min_value') || (count($value) > $this->element->getPropertyValue('max_value') && $this->element->getPropertyValue('max_value') > 0)) {
					if (($this->element->getPropertyValue('min_value') == $this->element->getPropertyValue('max_value') || $this->element->getPropertyValue('min_value') <= 0) && $this->element->getPropertyValue('max_value') > 0) $this->addError('ERROR_FILES_COUNT', array($this->element->getPropertyValue('max_value')));
					else $this->addError('ERROR_FILES_BETWEEN', array($this->element->getPropertyValue('min_value'), $this->element->getPropertyValue('max_value')));
				}
			break;
		}
	}
