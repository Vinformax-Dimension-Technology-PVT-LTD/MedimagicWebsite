												...
												<?php 
													...
													<div class="input-group option_row">
														...
														<div class="input-group-buttons">
															...
															<a href="javascript:;" onclick="ccmFormidableFormElementRemoveOptions(this);" class="btn btn-danger option_button" <?php if (count($element->getPropertyValue('options')) <= 1) {?>disabled="disabled"<?php } ?>>-</a> 
														</div>
													</div>
												<?php $i++; ?> 
												<?php } ?>
